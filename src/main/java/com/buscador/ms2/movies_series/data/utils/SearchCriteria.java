...
public class SearchCriteria<MediaElement> implements Specification<MediaElement> {
    ...
    @Override
    public Predicate toPredicate(Root<MediaElement> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
